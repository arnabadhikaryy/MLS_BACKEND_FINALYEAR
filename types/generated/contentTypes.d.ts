  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      [
        ...
        'Introduction',
        'Fundraising Communication History',
        'Prospecting and Lead Generation',
        'Fundraising Channels and Execution Mastery',
      ]
    >;
...
export interface ApiLessonProgressLessonProgress
  ...
  attributes: {
    bookmarked: Schema.Attribute.Boolean;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contenttype: Schema.Attribute.Enumeration<['video', 'pdf', 'quiz']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    quiz_in_video: Schema.Attribute.Boolean;
    quiz_timestamp_in_sec: Schema.Attribute.Integer;
    resources_link: Schema.Attribute.String;
    resources_pdf: Schema.Attribute.Media<
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    quiz: Schema.Attribute.Relation<'manyToOne', 'api::quiz.quiz'>;
    type: Schema.Attribute.Enumeration<['MCQ', 'TrueFalse', 'OpenEnded']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    quiz: Schema.Attribute.Relation<'manyToOne', 'api::quiz.quiz'>;
    quiz_status: Schema.Attribute.Enumeration<['Pending', 'Graded']>;
